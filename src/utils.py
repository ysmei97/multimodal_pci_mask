...
def norm_vol(data):
    data = data.astype(np.float) # cast data to float type
    index = data.nonzero()
    smax = np.max(data[index]) # data[index] value of non-zero elements
...
def save_one_image_label_pre(images, label, predict, save_dir):
    ...
    # imageio.imwrite(save_dir, output)
    plt.imsave(save_dir, output)
...
def iou_4class(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-3)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-3)
    :return:
    """
    ious = []           # len:  bz * temporal * class
    predicts = np.asarray(predicts.long()).flatten()
    target = np.asarray(target.long()).flatten()
    for i in range(5):  # for label i (0,1,2,4)
        if i == 3:
            continue
        predict = ((predicts == i) + 0)  # 2D Long np.array 240 * 240
        tar = ((target == i) + 0)  # 2D Long np.array 240 * 240
...
def dice_et(predicts, target):
    ...
    predict = ((predicts == 4) + 0)  # 1D Long np.array 240 * 240
    tar = ((target == 4) + 0)        # 1D Long np.array 240 * 240
    # score = cal_iou(predict, tar)
    score = dice(predict, tar)
    return score


def dice_tc(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
    ...
    predict = ((predicts == 1) + 0) != ((predicts == 4) + 0)  # 1D Long np.array 240 * 240
    tar = ((target == 1) + 0) != ((target == 4) + 0)          # 1D Long np.array 240 * 240
    # score = cal_iou(predict, tar)
    score = dice(predict, tar)
    return score
...
def sensitivity_wt(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def sensitivity_et(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def sensitivity_tc(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def precision_wt(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
    ...
    tar = ((target > 0) + 0)        # 1D Long np.array 240 * 240
    # score = cal_iou(predict, tar)
    score = precision(predict, tar)
    return score


def precision_et(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def precision_tc(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def specificity(predict, target):
    ...
    """
    smooth = 0.0001
    true_negative = float(((1 - target) * (1 - predict)).sum())
    return (true_negative + smooth) / (float((1 - predict).sum()) + smooth)


def specificity_wt(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
    ...
    tar = ((target > 0) + 0)        # 1D Long np.array 240 * 240
    # score = cal_iou(predict, tar)
    score = specificity(predict, tar)
    return score


def specificity_et(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
...
def specificity_tc(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
